...
export const SETTING_DEFAULTS = {
  ...
  'sso.enabled': 'false',
  'sso.baseUrl': 'https://tccommon.17usoft.com',
  'sso.clientId': 'bx.commom.tools',
  'sso.clientSecret': '',
  'sso.sessionSecret': '',
  'sso.publicOrigin': 'https://bx-tools.17usoft.com',
  'sso.redirectUri': '',
  'sso.callbackPath': '/api/auth/sso/callback',
  'sso.cookieSecure': 'true',
  'sso.cookieName': 'bx_tools_session',
  'sso.sessionMaxAge': '518400',
  'sso.sameSite': 'Lax',
  'sso.scope': 'read',
  'sso.timeoutSeconds': '10',
  'authority.enabled': 'false',
  'authority.baseUrl': 'http://servicegw.ly.com/gateway/authority/interface',
  'authority.appKey': '',
  'authority.appCode': '',
  'authority.labradorToken': '',
  'authority.tid': '',
  'authority.allowedAdminRoleNames': 'admin',
  'authority.allowedAdminRoleIds': '',
  'authority.adminUserIds': '',
} as const
