...
import AgentSettingsPage from '../views/AgentSettingsPage.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/agent', name: 'agent', component: AgentWorkspace },
    { path: '/agent/settings', name: 'agent-settings', component: AgentSettingsPage },
    ...
    { path: '/tool/ai-assistants', name: 'AiAssistants', component: AgentWorkspace },
